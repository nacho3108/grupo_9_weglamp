window.addEventListener("load", () => {
    ...
    let inputComment = form.querySelector("#comment");
    let inputImage = form.querySelector("#image");

    let inputArray = [inputDestination, inputName, inputPax, inputPrice,inputComment, inputImage];
    ...
    let errorComment = form.querySelector(".msg-error-comment");
    ...
    const validate = e => {
        ...
        if(!inputComment.value){
            hasErrors = true;
            errorComment.innerText = "Por favor ingrese una descripcion";
        }
